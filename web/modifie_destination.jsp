...
<section id="form-inscrit">
    <div class="container">
        <h4 style="text-align: center; padding-top: 40px">Modifier une Destination</h4>
    <br> <br>
    <div class="container">
            ...
            <div class="card-body">
                <form action="/Edit_destination" method="post">
                    <div class="form-group row">
                        <label for="id" class="col-sm-2 col-form-label">Id_destination:</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="id" name="id" value="${destination.idDestination}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="designation" class="col-sm-2 col-form-label">Designation:</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="designation" name="designation" value="${destination.designation}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="hotel" name="hotel" value="${destination.hotelSejoure}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="nb_jour" class="col-sm-2 col-form-label">Nombre de jour:</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="nb_jour" name="nb_jour" value="${destination.nbrJour}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="date_depart" class="col-sm-2 col-form-label">Date de depart:</label>
                        <div class="col-sm-6">
                            <input type="date" class="form-control" id="date_depart" name="date_depart" value="${destination.dateDepart}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="p_adulte" class="col-sm-2 col-form-label">Prix Adulte :</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="p_adulte" name="p_adulte" value="${destination.prixAdulte}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="p_enfant" class="col-sm-2 col-form-label">Prix enfant:</label>
                        <div class="col-sm-6">
                            <input type="tel" class="form-control" id="p_enfant" name="p_enfant" value="${destination.prixAdo}">
                        </div>
                    </div>
